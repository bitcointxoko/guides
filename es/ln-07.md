...
- Resumen: En este capítulo, nos adentraremos en los detalles técnicos sobre cómo se añaden y eliminan los HTLC durante el funcionamiento normal de un canal previo a Taproot, así como en cómo podemos actualizar las tarifas y restablecer conexiones.
