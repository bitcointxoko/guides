...
- Resumen: In this chapter, we will go into the technical details about how HTLCs are added and removed during the normal operation of a pre-taproot channel. 
...
- [Operación normal del canal](#operación-normal-del-canal)
  ...
  - [Eliminando HTLCs](#eliminando-htlcs)
    - [Paso 12: Bob -> Alice: update_fulfill_htlc(A2)](#paso-12-bob---alice-update_fulfill_htcla2)
    ...
    - [Paso 15: Alice -> Bob: update_fulfill_htlc(B1)](#paso-15-alice---bob-update_fulfill_htclb1)
    - [Paso 16: Bob -> Alice: commitment_signed](#paso-16-bob---alice-comitment_signed)
    - [Paso 17: Alice -> Bob: revoke_and_ack](#paso-17-alice---bob-revoke_and_ack)
    - [Paso 18: Alice -> Bob: commitment_signed](#paso-87-alice---bob-commitment_signed)
